...
export const heroPanelTheme = tv({
    slots: {
        ...
        supportButton: 'inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#00b9fe] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:brightness-105 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00b9fe] focus-visible:ring-offset-2 sm:w-auto sm:self-start',
